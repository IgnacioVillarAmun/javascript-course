...
// createBooking('LM123', undefined, 10000);

// const flight = 'LM234';
// const jonas = {
//   name: 'Jonas Lol',
//   passport: 2346812873912,
// };
...
//   if (passenger.passport === 2346812873912) {
//     alert('Checked in');
//   } else {
...
// const hugh5 = function () {
//   console.log('😀');
// };

// document.body.addEventListener('click', hugh5);

// ['Jonas', 'Marta', 'Adam'].forEach(hugh5);
...
// lufthansa.book(239, 'Ignacio Villar');
...
// book.call(swiss, 278, 'Jhon Linkon');
...
// const taxRet = function (rate) {
//   return function (value) {
//     return value + value * rate;
//   };
// };

// const taxTest = taxRet(0.5)
// console.log(taxTest(100));
...
and the 'string' option. Do NOT put the arrays in the poll object! So what shoud the this keyword 
...
color of the selected h1 element ('header') to blue, each time the BODY element is clicked. 
